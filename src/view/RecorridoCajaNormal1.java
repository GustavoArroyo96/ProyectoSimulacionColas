...
public class RecorridoCajaNormal1 implements Runnable{
    ...
    public RecorridoCajaNormal1(VentanaSimulacion ventanaSimulacion, ArrayList<ClientesNormal> clientesNormal, int contadorArrayClientesNormal){
    ...
    public void run() {
        ...
        ventanaSimulacion.caja3Disponible = false;
        ventanaSimulacion.cj3.setVisible(false);
        ...
        while(concurrencia) {
            if (contadorTiempoSeg < tRecorridoA) {
                ...
                ventanaSimulacion.caja3Disponible = true;
                ventanaSimulacion.cj3.setVisible(true);
                concurrencia = false ;
            }
            try {
                ventanaSimulacion.revalidate();
