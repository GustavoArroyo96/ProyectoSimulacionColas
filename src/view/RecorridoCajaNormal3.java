...
public class RecorridoCajaNormal3 implements Runnable{
    ...
    public RecorridoCajaNormal3(VentanaSimulacion ventanaSimulacion, ArrayList<ClientesNormal> clientesNormal, int contadorArrayClientesNormal){
    ...
    public void run() {
        ...
        ventanaSimulacion.caja5Disponible = false;
        ventanaSimulacion.cj5.setVisible(false);
        ...
        while(concurrencia) {
            if (contadorTiempoSeg < tRecorridoA) {
                ...
                ventanaSimulacion.caja5Disponible = true;
                ventanaSimulacion.cj5.setVisible(true);
                concurrencia = false ;
            }
            try {
                ventanaSimulacion.revalidate();
