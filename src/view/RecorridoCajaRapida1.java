...
public class RecorridoCajaRapida1 implements Runnable {
    ...
    public RecorridoCajaRapida1(VentanaSimulacion ventanaSimulacion, ArrayList<ClientesRapida> clientesRapida, int contadorArrayClientesRapida) {
    ...
    public void run() {
        ...
        ventanaSimulacion.caja1Disponible = false;
        ventanaSimulacion.cj1.setVisible(false);
        ...
        while(concurrencia) {
            if (contadorTiempoSeg < tRecorridoA) {
                ...
                ventanaSimulacion.caja1Disponible = true;
                ventanaSimulacion.cj1.setVisible(true);
                concurrencia = false;
            }
            try {
                ventanaSimulacion.revalidate();
