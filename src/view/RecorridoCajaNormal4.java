...
public class RecorridoCajaNormal4 implements Runnable{
    ...
    public RecorridoCajaNormal4(VentanaSimulacion ventanaSimulacion, ArrayList<ClientesNormal> clientesNormal, int contadorArrayClientesNormal){
    ...
    public void run() {
        ...
        ventanaSimulacion.caja6Disponible = false;
        ventanaSimulacion.cj6.setVisible(false);
        ...
        while(concurrencia) {
            if (contadorTiempoSeg < tRecorridoA) {
                ...
                ventanaSimulacion.caja6Disponible = true;
                ventanaSimulacion.cj6.setVisible(true);
                concurrencia = false ;
            }
            try {
                ventanaSimulacion.revalidate();
